      ...
      <div className=" bg-slate-200">
        <div className="flex flex-col md:flex-row justify-around items-center py-4">
          <div className="flex justify-center space-x-4">
            ...
            <ul className="space-y-1 text-lg text-cyan-900">
              <li>Contact Us</li>
          ...
          <div>
            <ul className="grid grid-cols-2 md:grid-cols-3 gap-4 text-lg text-cyan-900">
              <li>Platform</li>
              <li>Resources</li>
        ...
        <div className="border-2 h-1 border-b-indigo-800"></div>
      </div>
      <div className="flex justify-between items-center mx-3">
        <div>
          <ul className="text-2xl flex space-x-2">
